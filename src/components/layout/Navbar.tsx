...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { path: '/post-history', label: 'Post History', icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    { path: '/brand-kit', label: 'Brand Kit', icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="navbar-container">
          <div className="navbar-left">
            <Link to="/dashboard" className="navbar-logo">
              ...
              <span className="logo-text">SoloCreatorHub AI</span>
            </Link>
          ...
          <div className="sidebar-footer">
            <div className="plan-info">
              ...
              <div className="plan-usage">
                <div className="usage-label">Storage: 70% used</div>
                <div className="usage-bar">
                  <div className="usage-progress" style={{ width: '70%' }}></div>
                </div>
              </div>
            </div>
